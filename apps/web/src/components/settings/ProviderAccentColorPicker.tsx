    ...
    <div className="w-56 bg-popover">
      ...
      <div className="grid gap-3 p-3">
        ...
        <input
          ...
          aria-label={t("providers.instance.customAccentHex")}
          spellCheck={false}
        />
      </div>
    </div>
      ...
      <PopoverTrigger
        render={
          <button
            ...
            aria-label={t("providers.instance.customAccent", { provider: props.displayName })}
          >
  ...
  return (
    <div className="grid gap-2">
      <span className="text-xs font-medium text-foreground">
        {t("providers.instance.accentColor")}
      </span>
      <div className="flex min-w-0 flex-wrap items-center gap-2">
        ...
        <ColorSelector
          ...
          size="lg"
          colorAriaLabel={(color) => t("providers.instance.selectAccent", { color })}
        ...
        <Button
          ...
          aria-label={t("providers.instance.clearAccent", { provider: displayName })}
