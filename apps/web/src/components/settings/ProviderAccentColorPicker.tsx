    ...
    <div className="w-56 bg-popover">
      ...
      <div className="grid gap-3 p-3">
        ...
        <input
          ...
          aria-label={t("providers.accent.customHex")}
          spellCheck={false}
        />
      </div>
    </div>
      ...
      <PopoverTrigger
        render={
          <button
            ...
            aria-label={t("providers.accent.chooseFor", { provider: props.displayName })}
          >
...
export function ProviderAccentColorPicker(props: {
  ...
  return (
    <div className="grid gap-2">
      <span className="text-xs font-medium text-foreground">{t("providers.accent.label")}</span>
      {picker}
