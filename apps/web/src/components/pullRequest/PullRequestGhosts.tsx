...
export function PullRequestListGhost({
  ...
  return (
    <div
      role="status"
      aria-label={caption ?? t("pullRequests.loading.list")}
...
export function PullRequestDetailGhost({ seed }: { seed?: PullRequestListEntry | null }) {
  ...
  return (
    <div
      role="status"
      aria-label={t("pullRequests.loading.detail")}
      className={cn(
...
export function PullRequestPeopleGhost({ rows = 4 }: { rows?: number }) {
  ...
  return (
    <div
      role="status"
      aria-label={t("pullRequests.loading.people")}
...
export function PullRequestTimelineGhost({ rows = 6 }: { rows?: number }) {
  ...
  return (
    <div
      role="status"
      aria-label={t("pullRequests.loading.timeline")}
...
export function PullRequestConversationGhost({ rows = 3 }: { rows?: number }) {
  ...
  return (
    <div
      role="status"
      aria-label={t("pullRequests.loading.conversation")}
