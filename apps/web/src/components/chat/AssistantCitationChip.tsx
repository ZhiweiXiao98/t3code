...
export function AssistantCitationChip({
  ...
  const composerSourceLink = (
    <Link
      ...
      aria-label={t("citation.viewText", { text: label })}
    >
    ...
    >
      {onRemove ? (
        ...
        <Tooltip>
          ...
          <TooltipPopup side="top">{t("citation.viewSource")}</TooltipPopup>
        </Tooltip>
      )}
      {commentEditor ? (
        <Popover open={commentEditor.open} onOpenChange={commentEditor.onOpenChange}>
          <PopoverTrigger
            aria-label={citation.comment ? t("citation.editComment") : t("citation.addComment")}
          ...
          {commentEditor.open ? (
            <PopoverPopup
              ...
              aria-label={t("citation.editComment")}
